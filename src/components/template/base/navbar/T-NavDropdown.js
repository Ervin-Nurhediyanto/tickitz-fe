  ...
  render() {
    return (
      <Nav pullRight className='d-lg-none d-flex'>
        ...
        >
          <NavDropdown.Item eventKey="4.1" onClick={() => { this.props.history.push('/') }}>Home</NavDropdown.Item>
          ...
          <NavDropdown.Item eventKey="4.5" onClick={() => { this.props.history.push('/manage/movie') }}>Manage Movie</NavDropdown.Item>
